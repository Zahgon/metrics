...
func RegisterSet(s *Set) { _ = "STUB: not implemented"; return }
...
func UnregisterSet(s *Set, destroySet bool) { _ = "STUB: not implemented"; return }
...
func RegisterMetricsWriter(writeMetrics func(w io.Writer)) { _ = "STUB: not implemented"; return }
...
//	})
func WritePrometheus(w io.Writer, exposeProcessMetrics bool) { _ = "STUB: not implemented"; return }
...
func WriteProcMetrics(w io.Writer) { _ = "STUB: not implemented"; return }
...
func UnregisterMetric(name string) bool { _ = "STUB: not implemented"; return false }
...
func UnregisterAllMetrics() { _ = "STUB: not implemented"; return }

// ListMetricNames returns sorted list of all the metric names from default set.
func ListMetricNames() []string { _ = "STUB: not implemented"; return nil }
...
func ExposeMetadata(v bool) { _ = "STUB: not implemented"; return }

func isMetadataEnabled() bool { _ = "STUB: not implemented"; return false }

var exposeMetadata uint32

func isCounterName(name string) bool { _ = "STUB: not implemented"; return false }

// WriteGaugeUint64 writes gauge metric with the given name and value to w in Prometheus text exposition format.
func WriteGaugeUint64(w io.Writer, name string, value uint64) { _ = "STUB: not implemented"; return }

// WriteGaugeFloat64 writes gauge metric with the given name and value to w in Prometheus text exposition format.
func WriteGaugeFloat64(w io.Writer, name string, value float64) { _ = "STUB: not implemented"; return }

// WriteCounterUint64 writes counter metric with the given name and value to w in Prometheus text exposition format.
func WriteCounterUint64(w io.Writer, name string, value uint64) { _ = "STUB: not implemented"; return }
...
func writeMetadata(w io.Writer, metricFamily, metricType string) { _ = "STUB: not implemented"; return }

func getMetricFamily(metricName string) string { _ = "STUB: not implemented"; return "" }
